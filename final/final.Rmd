...
abstract: |
  Bu çalışmada büyümenin; faiz, döviz kuru, para arzı ve enflasyona bağlı olarak değişimi ele alınmıştır. Bu değişkenlere bağlı olarak büyümenin ne derecede etkilendiği regresyon analizi yapılarak ve özet istatistik tablosu ve saçılım grefiği yardımıyla araştırılmıştır. Çalışmada Klasik Teori, Keynesyen Teori ve Monetarist Teori yardımcı unsurlar olarak kullanılmıştır.
---
...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: 20080281, [Github Repo](https://github.com/inal7206/finalodeviyeni)
...
```{r, echo=FALSE}
library(readr)
Veriler <- read_csv("C:/Users/arahi/OneDrive/Masaüstü/20080281/finalodeviyeni/data/Veriler.csv")
View(Veriler)
```
...
```{r, echo=FALSE}
library(ggplot2)
ggplot(Veriler, aes(x = date, y = g)) +
geom_point()
```

    YUKARIDAKİ GRAFİK YILLARA GÖRE EKONOMİK BÜYÜMEDEKİ DEĞİŞİMİ GÖSTERMEKTEDİR.
